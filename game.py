...
class Game:
    ...
    def draw(self):
        ...
        self.glass.draw()
        self.next_box.draw()
        self.pause_butt.create_button(self.screen, sett.WHITE, 640, 420, 100, 80, 3, "Пауза", sett.BLACK)
        self.curr_fig.draw()
    ...
    def check_events(self):
        ...
        if pygame.key.get_pressed()[pygame.K_LEFT]:
            if pygame.time.get_ticks() - self.hor_control_tick >= sett.hor_moving_delay:
    ...
    def destroy_lines(self):
        """Проверяет свободность всех линий стакана. Удаляет заполненные линии.
    ...
    def dead_cubes_operator(self):
        """Сортирует неподвижные кубики. Удаляет кубики из уничтоженных линий.
