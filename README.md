...
<img src="https://imgur.com/1ZWNrWy.png" width="500">
...
фигура медленно опускается, пока не встретит препятствие - нижнюю границу стакана или ранее опустившуюся фигуру.
    ...
    <img src="https://imgur.com/n2Bgf8k.png" width="500">
...
нажмите **Продолжить**, а для выхода из игры - **Выйти из игры**.
    ...
    <img src="https://imgur.com/860QwYX.png" width="500">
...
выйти в главное меню.
    ...
    <img src="https://imgur.com/GkIZ9HT.png" width="500">

### Настройки

1. Раздел **Настройки** можно открыть нажатием соответствующей кнопки в главном меню.

    <img src="https://imgur.com/bFIBoyR.png" width="500">
...
4. В настройках также можно изменить цветовую тему игровых окон. По умолчанию установлена **Светлая** тема. При
необходимости ее можно поменять на **Темную**. Пользуйтесь кннопками в столбце **Тема**.
...
наибольшее количество очков, когда-либо набранное за одну игру.
    ...
    <img src="https://imgur.com/otwT7SF.png" width="500">
